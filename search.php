...
function cursorfocus(){
 document.admin.booktitle.focus();
 }
//--></script>
...
<body bgcolor="#d5d5d5"  onLoad="MM_preloadImages('images/header_r2_c1_f2.gif','images/header_r2_c5_f3.gif','images/header_r2_c9_f4.gif','images/header_r2_c13_f5.gif','images/header_r2_c17_f6.gif','images/header_r2_c18_f6.gif','images/header_r2_c18_f7.gif','images/header_r2_c19_f7.gif');cursorfocus();">
...
<table width="741" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <form action="listsearch.php" name="admin" method="post" enctype="multipart/form-data">
  <tr>
    <td align="center"> <span class="fontstyle1"><strong>IT-Books+ Search Engine</strong>
      </span>
      <p><input name="booktitle" type="text" class="formstyle" size="75" value="<?php
	  if(isset($_POST['booktitle'])){echo $_POST['booktitle'];}
	  ?>">
      <p>
      <input name="srch4bk" type="submit" class="formstyle" value="Search for book(s) in our store">
      <p><strong>Note</strong>: - You can search by author's name, publisher's name, keyword(s) or isbn. </td>
  </tr>
  </form>
  <form action="<?php echo $_SERVER['PHP_SELF'];?>" name="admin1" method="post" enctype="multipart/form-data">
  <tr>
    <td align="center"><p>&nbsp;</p>
      <p><strong>List all books in  category</strong>&nbsp;&nbsp;&nbsp;&nbsp;            
        <select name="category" class="formstyle" id="category">
<?php
if(($_POST['category']!='-----------------')){$category=$_POST['category'];$searchtype->set("category","$category");}
 if($searchtype->get("category")){echo "<option value='".$searchtype->get("category")."'>".$searchtype->get("category")."</option>";}
 ...
 <option value="Programming">Programming</option>
        ...
        &nbsp;&nbsp;
            <input name="srchbycat" type="submit" class="formstyle" value="GO">
</p></td>
  </tr>
  <tr><td><p>&nbsp;</p>
    <p>
...
if(isset($_POST['srch4bk'])){$searchtype->set('callfile','search_class4intxt.php');}
elseif(isset($_POST['srchbycat'])){$searchtype->set('callfile','search_class4cat.php');}
$callfile=$searchtype->get('callfile');
if((isset($_POST['srch4bk']))||(isset($_POST['srchbycat']))){
require "$callfile";
$searchresult=new rowbyrow;}
if((isset($_POST['submit']))&&(isset($_POST['page']))){
require "$callfile";
$searchresult=new rowbyrow;
$searchresult->jump_page();}
elseif(isset($_POST['navigate'])){require "$callfile";
$searchresult=new rowbyrow;$searchresult->navigation();}
elseif(isset($_POST['srch4bk'])){require "$callfile";
$searchresult=new rowbyrow;$searchresult->displayinfo();}
elseif((isset($_POST['srchbycat']))&&($_POST['category']!='-----------------')){
