...
//if(isset($_SESSION['admin'])){header('location: admin_home.php');}
...
<table width="741" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="50%"  border="0" align="center" cellpadding="3" cellspacing="3">
  <caption align="top">
  <strong>  LOG IN
  </strong>
  </caption>
  ...
  <tr>
    <td>E-mail</td>
	    <td><input name="email" type="text" class="formstyle" id="email" size="30"></td>
  </tr>
  <tr>
      <td>Password</td>
      <td><input name="password" type="password" class="formstyle" id="password" size="30"></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><input name="login" type="submit" class="formstyle" id="login" value="Submit"></td>
  </tr>
  <tr><td height="35" colspan="2" align="center"><?php

 if((isset($_POST['login']))&&(!(empty($_POST['email'])))){
   $membermess=$member->membersmessage();
echo $membermess;        }
elseif($chkmemberstatus->get("membership")){
echo "Is this your first on this site? <a href='catalog.php'><strong class='boldlink'>Click here to start shopping</strong></a><p>";
echo "Want to check your shopping details/tracking information? <a href='cart.php'><strong class='boldlink'>Click here to view all</a></strong>";
}
...
echo "<p><center> <strong>Welcome Admin. </strong><a href='admin_home.php'>click here</a></center></p>";
}
  ...
  <tr><td height="10" colspan="2" align="center"><?php
  if((isset($_POST['sendpwd']))&&(!(empty($_POST['myemail'])))){$retrievepwd=new pwdrecovery();echo $retrievepwd->message;}
?></td>
  </tr>
  <tr>
    <td width="30%">E-mail</td>
	    <td width="70%"><input name="myemail" type="text" class="formstyle" id="myemail" size="30"></td>
  </tr>
  
  <tr>
    <td>&nbsp;</td>
    <td><input name="sendpwd" type="submit" class="formstyle" id="sendpwd" value="Send my password"></td>
  </tr>
  <tr><td height="35" colspan="2" align="center"><?php
 if((isset($_POST['login']))&&(!(empty($_POST['email'])))){
  if(($member->get("membership"))){echo "<a href='login.php?logout=true'><strong class='boldlink'>Click here to log out</strong></a>";}
           }
		   elseif($chkmemberstatus->get("membership")){echo "<a href='login.php?logout=true'><strong class='boldlink'>Click here to log out</strong></a>";}
  ...
  <tr>
    <td align="center"><a href="account.php?chgpwd=true">Click here to change your password</a></td>
  </tr>
</table>
