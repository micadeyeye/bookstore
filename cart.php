...
$sql="select * from chosenitems where email='$email' and itemstatus='unsettled'";
$result=$db->query($sql);
...
echo "<tr bgcolor='#99BFE6'><td>Book Title</td><td><strong>".$row['title']."</strong></td><td>Delivery Service</td><td><strong>".$row['deliveryservice']."</strong></td></tr>"; 
...
echo "<tr><td>Request Date</td><td>".$row['requestdate']." (YYYY-MM-DD)</td><td>Payment Confirmation Date</td><td>".$row['paymentconfirmationdate']."</td></tr>"; 
echo "<tr><td>Postal Date</td><td>".$row['postaldate']."</td><td>Delivery Confirmation Date</td><td>".$row['deliveryconfirmationdate']."</td></tr>"; 
}
echo "<tr><td colspan='4' align='right'><hr class='dashline' width='100%' size='1'><strong class='fontstyle1'>Total cost of all your shopping=</strong><strong><img src='oth_images/naira_sign.gif'>$allitemsoverallcost</strong></td></tr></table>";
...
echo "Here is your <strong class='fontstyle1'>Shopping Details</strong> and <strong class='fontstyle1'>Tracking information</strong>";
?>
...
$shoppingdetails->showdetails();}
	  ...
	  Thanks for your interest in buying these book(s). With all assurance, the goods will be safely and securely shipping to you immediately after payment is confirmed. <strong>Your preferred payment mode remains</strong> 
	  <?php
	  echo "<strong class='fontstyle1'>".$shoppingdetails->paymentmode."</strong>. <a href='account.php'>confirm it here</a>";	  
	  ?>
	  <p align="center"><a href="settledtransaction.php">Click here to view your completed transactions if any</a></p>  <P align="center">To prevent account hijack, you are strongly advised to log out when you are through with this site.<br>
