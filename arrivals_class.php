...
//run the query now
$sql="select booksnumber,category,author,picturecode,title,newprice,yrpublish,backcoverdetails from catalog where ((version='New') and (".$_SESSION['categoryselected'].")) LIMIT $p,$this->n";
//echo $sql;exit;
$result=$db->query($sql);
...
$short_str=substr($row['backcoverdetails'],0,350)."..... <a class='fontstyle4x' href='addtocart.php?booksnumber=".$row['booksnumber']."'>details here</a>";
...
return $this->str1;
 ...
 $sql="select count(*) from catalog where ((version='New') and (".$_SESSION['categoryselected']."))";
