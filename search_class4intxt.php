...
//  echo $this->booktitle;exit;
	  ...
	  $sql= "select booksnumber,title,author,publisher,backcoverdetails,isbn, match(title,author,publisher,backcoverdetails,isbn) against('".$booktitle."') as relevance from catalog where match(title,author,publisher,backcoverdetails,isbn) against('".$booktitle."') LIMIT $p,$this->n";
$result=$db->query($sql);
...
$booktitle=$_POST['booktitle'];
$this->booktitle=$booktitle;
	  $sql= "select title,author,publisher,backcoverdetails,isbn, match(title,author,publisher,backcoverdetails,isbn) against('".$booktitle."') as relevance from catalog where match(title,author,publisher,backcoverdetails,isbn) against('".$booktitle."')";
