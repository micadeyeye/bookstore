...
shippingdetails='$this->shippingdetails' where booksnumber=$booksnumber";
//echo $sql;

$result=$db->query($sql);
$pixcodename=$cat.$booksnumber;
...
$sql="UPDATE catalog SET
picturecode='$this->pixcodename' where booksnumber=$booksnumber";
$db->query($sql);
...
if(isset($_POST['Update'])){new updatebook();}
